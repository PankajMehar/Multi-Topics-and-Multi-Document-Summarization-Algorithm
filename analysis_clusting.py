...
def main():
    ...
    for i in range(1,100):
        pre = process_file(r"C:\Users\Yuhsuan\Desktop\MEMDS\arrange_day_0\final_group_file_reference\{}.json".format(i))
        log(i,lvl='i')
        res.append(metrics_value(answer,pre))
    df = pd.DataFrame(res)
    df.to_csv(r"C:\Users\Yuhsuan\Desktop\MEMDS\arrange_day_0\res.csv", sep=',', encoding='utf-8')
...
def process_file(file_path):
    ...
    for group in data:
        ...
        # print("source_data: %s" % source_data)
